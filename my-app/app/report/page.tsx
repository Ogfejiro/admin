    ...
    <div className="min-h-screen bg-gray-100 dark:bg-gray-950 p-4 sm:p-8 font-sans antialiased">
      <header className="mb-6 md:mb-10 flex flex-col md:flex-row md:items-center md:justify-between">
        <div className="mb-4 md:mb-0">
          <h1 className="text-2xl sm:text-3xl md:text-4xl font-extrabold text-gray-900 dark:text-gray-50">Tabular Report</h1>
          <p className="mt-1 text-sm sm:text-base md:text-lg text-gray-500 dark:text-gray-400">A detailed breakdown of monthly metrics</p>
        </div>
          ...
          <thead className="bg-gray-50 dark:bg-gray-700">
            <tr>
              <th className="px-3 py-2 sm:px-6 sm:py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">
                <Button variant="ghost" onClick={() => handleSort('month')} className="flex items-center gap-1 dark:hover:bg-gray-600 dark:text-gray-300">
                  Month {getSortIcon('month')}
                </Button>
              </th>
              <th className="px-3 py-2 sm:px-6 sm:py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">
                <Button variant="ghost" onClick={() => handleSort('name')} className="flex items-center gap-1 dark:hover:bg-gray-600 dark:text-gray-300">
                  Name {getSortIcon('name')}
                </Button>
              </th>
              <th className="px-3 py-2 sm:px-6 sm:py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">
                <Button variant="ghost" onClick={() => handleSort('state')} className="flex items-center gap-1 dark:hover:bg-gray-600 dark:text-gray-300">
                  State {getSortIcon('state')}
                </Button>
              </th>
              <th className="px-3 py-2 sm:px-6 sm:py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">
                <Button variant="ghost" onClick={() => handleSort('time')} className="flex items-center gap-1 dark:hover:bg-gray-600 dark:text-gray-300">
                  Time {getSortIcon('time')}
                </Button>
              </th>
              <th className="px-3 py-2 sm:px-6 sm:py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">
                <Button variant="ghost" onClick={() => handleSort('sales')} className="flex items-center gap-1 dark:hover:bg-gray-600 dark:text-gray-300">
                  Sales {getSortIcon('sales')}
                </Button>
              </th>
              <th className="px-3 py-2 sm:px-6 sm:py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">
                <Button variant="ghost" onClick={() => handleSort('success')} className="flex items-center gap-1 dark:hover:bg-gray-600 dark:text-gray-300">
                  Success {getSortIcon('success')}
                </Button>
              </th>
              <th className="px-3 py-2 sm:px-6 sm:py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">
                <Button variant="ghost" onClick={() => handleSort('pending')} className="flex items-center gap-1 dark:hover:bg-gray-600 dark:text-gray-300">
          ...
          <tbody className="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
            {filteredData.map((row) => (
              <tr key={row.id} className="hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors duration-200">
                ...
                <td className="px-3 py-2 sm:px-6 sm:py-4 whitespace-nowrap text-sm font-medium text-gray-900 dark:text-gray-50">{row.time}</td>
                <td className="px-3 py-2 sm:px-6 sm:py-4 whitespace-nowrap text-sm font-medium text-blue-600 dark:text-blue-400">${row.sales.toLocaleString()}</td>
                <td className="px-3 py-2 sm:px-6 sm:py-4 whitespace-nowrap text-sm font-medium text-green-600 dark:text-green-400">${row.success.toLocaleString()}</td>
                <td className="px-3 py-2 sm:px-6 sm:py-4 whitespace-nowrap text-sm font-medium text-yellow-600 dark:text-yellow-400">${row.pending.toLocaleString()}</td>
              </tr>
            ))}
          </tbody>
        </table>
