      ...
      <div className="grid gap-4 md:hidden">
        {filteredData.map((row) => (
          ...
          >
            ...
            <h2 className="mt-2 font-semibold text-gray-900 dark:text-gray-50">{row.name}</h2>
            <p className="text-gray-500 dark:text-gray-400">{row.state}</p>
            <div className="mt-3 grid grid-cols-3 gap-2 text-sm">
              <div className="text-blue-600 dark:text-blue-400">Sales: ${row.sales.toLocaleString()}</div>
              <div className="text-green-600 dark:text-green-400">Success: ${row.success.toLocaleString()}</div>
              <div className="text-yellow-600 dark:text-yellow-400">Pending: ${row.pending.toLocaleString()}</div>
            </div>
          </div>
        ))}
      </div>
